...
Програма визначає розмір time_t (64 біти) та демонструє переповнення при спробі перевищити максимальне значення (2^63 - 1), що призводить до переходу у мінімальне від'ємне. У 32-х бітній системі відповідно 2^31 - 1, тобто діапазон складає 2147483647 та -2147483648
